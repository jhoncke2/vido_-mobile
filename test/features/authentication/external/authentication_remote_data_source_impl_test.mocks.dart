...
// in vido/test/features/authentication/external/authentication_remote_data_source_impl_test.dart.
...
import 'package:vido/features/authentication/domain/entities/user.dart' as _i7;
...
/// A class which mocks [AuthenticationRemoteAdapter].
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthenticationRemoteAdapter extends _i1.Mock
    implements _i6.AuthenticationRemoteAdapter {
  MockAuthenticationRemoteAdapter() {
    _i1.throwOnMissingStub(this);
  }

  @override
  String getStringJsonFromUser(_i7.User? user) =>
      (super.noSuchMethod(Invocation.method(#getStringJsonFromUser, [user]),
