...
class _FakeCameraValue_2 extends _i1.Fake implements _i4.CameraValue {}

class _FakeXFile_3 extends _i1.Fake implements _i3.XFile {}

class _FakeWidget_4 extends _i1.Fake implements _i5.Widget {
  @override
...
class _FakeRandomAccessFile_9 extends _i1.Fake implements _i6.RandomAccessFile {
}

class _FakeIOSink_10 extends _i1.Fake implements _i6.IOSink {}

class _FakeFileStat_11 extends _i1.Fake implements _i6.FileStat {}
...
class MockCreateTranslationsFile extends _i1.Mock
  ...
  _i8.Future<_i2.Either<_i9.PhotosTranslatorFailure, int>> call(String? name) =>
      (super.noSuchMethod(Invocation.method(#call, [name]),
              returnValue:
                  Future<_i2.Either<_i9.PhotosTranslatorFailure, int>>.value(
                      _FakeEither_0<_i9.PhotosTranslatorFailure, int>()))
          as _i8.Future<_i2.Either<_i9.PhotosTranslatorFailure, int>>);
}
...
class MockTranslatePhoto extends _i1.Mock implements _i10.TranslatePhoto {
  ...
  _i8.Future<_i2.Either<_i9.PhotosTranslatorFailure, void>> call(
      ...
      (super.noSuchMethod(Invocation.method(#call, [photoUrl]),
              returnValue:
                  Future<_i2.Either<_i9.PhotosTranslatorFailure, void>>.value(
                      _FakeEither_0<_i9.PhotosTranslatorFailure, void>()))
          as _i8.Future<_i2.Either<_i9.PhotosTranslatorFailure, void>>);
}
...
class MockGetUncompletedTranslationsFiles extends _i1.Mock
    implements _i12.GetUncompletedTranslationsFiles {
  MockGetUncompletedTranslationsFiles() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i8.Future<_i2.Either<_i9.PhotosTranslatorFailure, List<_i13.TranslationsFile>>>
      call() => (super.noSuchMethod(Invocation.method(#call, []),
          returnValue:
              Future<_i2.Either<_i9.PhotosTranslatorFailure, List<_i13.TranslationsFile>>>.value(
                  _FakeEither_0<_i9.PhotosTranslatorFailure,
                      List<_i13.TranslationsFile>>())) as _i8
          .Future<_i2.Either<_i9.PhotosTranslatorFailure, List<_i13.TranslationsFile>>>);
}
...
class MockCameraController extends _i1.Mock implements _i4.CameraController {
  ...
  @override
  _i4.CameraValue get value => (super.noSuchMethod(Invocation.getter(#value),
      returnValue: _FakeCameraValue_2()) as _i4.CameraValue);
  @override
  set value(_i4.CameraValue? newValue) =>
  ...
  _i8.Future<void> startImageStream(_i4.onLatestImageAvailable? onAvailable) =>
      (super.noSuchMethod(Invocation.method(#startImageStream, [onAvailable]),
          ...
          returnValueForMissingStub: Future<void>.value()) as _i8.Future<void>);
  @override
  _i8.Future<void> stopImageStream() =>
  ...
  _i8.Future<double> getMinZoomLevel() =>
      (super.noSuchMethod(Invocation.method(#getMinZoomLevel, []),
          returnValue: Future<double>.value(0.0)) as _i8.Future<double>);
  @override
  _i8.Future<void> setZoomLevel(double? zoom) =>
      (super.noSuchMethod(Invocation.method(#setZoomLevel, [zoom]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i8.Future<void>);
  @override
  _i8.Future<void> setFlashMode(_i3.FlashMode? mode) =>
  ...
  _i8.Future<void> setExposureMode(_i3.ExposureMode? mode) =>
      (super.noSuchMethod(Invocation.method(#setExposureMode, [mode]),
          ...
          returnValueForMissingStub: Future<void>.value()) as _i8.Future<void>);
  @override
  _i8.Future<void> setExposurePoint(_i14.Offset? point) =>
  ...
  _i8.Future<void> lockCaptureOrientation(
      ...
      (super.noSuchMethod(
          ...
          returnValueForMissingStub: Future<void>.value()) as _i8.Future<void>);
  @override
  _i8.Future<void> setFocusMode(_i3.FocusMode? mode) =>
      (super.noSuchMethod(Invocation.method(#setFocusMode, [mode]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i8.Future<void>);
  @override
  _i8.Future<void> unlockCaptureOrientation() =>
      (super.noSuchMethod(Invocation.method(#unlockCaptureOrientation, []),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i8.Future<void>);
  @override
  _i8.Future<void> setFocusPoint(_i14.Offset? point) =>
...
/// A class which mocks [GetCompletedFiles].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetCompletedFiles extends _i1.Mock implements _i16.GetCompletedFiles {
  MockGetCompletedFiles() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i8.Future<_i2.Either<_i9.PhotosTranslatorFailure, List<_i17.PdfFile>>>
      call() => (super.noSuchMethod(Invocation.method(#call, []),
          returnValue:
              Future<_i2.Either<_i9.PhotosTranslatorFailure, List<_i17.PdfFile>>>.value(
                  _FakeEither_0<_i9.PhotosTranslatorFailure,
                      List<_i17.PdfFile>>())) as _i8
          .Future<_i2.Either<_i9.PhotosTranslatorFailure, List<_i17.PdfFile>>>);
}

/// A class which mocks [GeneratePdf].
///
/// See the documentation for Mockito's code generation for more information.
class MockGeneratePdf extends _i1.Mock implements _i18.GeneratePdf {
  MockGeneratePdf() {
    _i1.throwOnMissingStub(this);
  }
...
class MockFile extends _i1.Mock implements _i6.File {
  ...
  _i8.Future<_i6.RandomAccessFile> open(
      ...
      (super.noSuchMethod(Invocation.method(#open, [], {#mode: mode}),
              returnValue:
                  Future<_i6.RandomAccessFile>.value(_FakeRandomAccessFile_9()))
  ...
  _i6.RandomAccessFile openSync({_i6.FileMode? mode = _i6.FileMode.read}) =>
      (super.noSuchMethod(Invocation.method(#openSync, [], {#mode: mode}),
          returnValue: _FakeRandomAccessFile_9()) as _i6.RandomAccessFile);
  @override
  ...
  _i6.IOSink openWrite(
      ...
      (super.noSuchMethod(
          ...
          returnValue: _FakeIOSink_10()) as _i6.IOSink);
  @override
  _i8.Future<_i20.Uint8List> readAsBytes() =>
  ...
  _i20.Uint8List readAsBytesSync() =>
      (super.noSuchMethod(Invocation.method(#readAsBytesSync, []),
          returnValue: _i20.Uint8List(0)) as _i20.Uint8List);
  @override
  ...
  _i8.Future<_i6.FileStat> stat() =>
      (super.noSuchMethod(Invocation.method(#stat, []),
              returnValue: Future<_i6.FileStat>.value(_FakeFileStat_11()))
          as _i8.Future<_i6.FileStat>);
  @override
  _i6.FileStat statSync() =>
      (super.noSuchMethod(Invocation.method(#statSync, []),
          returnValue: _FakeFileStat_11()) as _i6.FileStat);
  @override
  _i8.Future<_i6.FileSystemEntity> delete({bool? recursive = false}) => (super
      .noSuchMethod(Invocation.method(#delete, [], {#recursive: recursive}),
          returnValue: Future<_i6.FileSystemEntity>.value(
              _FakeFileSystemEntity_12())) as _i8.Future<_i6.FileSystemEntity>);
  @override
